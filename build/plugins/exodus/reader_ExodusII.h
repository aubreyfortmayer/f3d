...
#ifndef F3DExodusII_h
#define F3DExodusII_h
...
class reader_ExodusII : public f3d::reader
{
public:
  reader_ExodusII() = default;

  /*
   * Get the name of this reader
   */
  const std::string getName() const override { return "ExodusII"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "Exodus II"; }
  ...
  {
    vtkNew<vtkExodusIIReader> geomReader;
...
#if 1
#include "/Users/aubreyfortmayer/f3d/plugins/exodus/exodus.inl"
#endif
