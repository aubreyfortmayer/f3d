...
#ifndef F3DVTKXMLVTP_h
#define F3DVTKXMLVTP_h
...
class reader_VTKXMLVTP : public f3d::reader
{
public:
  reader_VTKXMLVTP() = default;

  /*
   * Get the name of this reader
   */
  const std::string getName() const override { return "VTKXMLVTP"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "VTK XML PolyData"; }
  ...
  {
    static const std::vector<std::string> ext = { "vtp" };
    return ext;
  }
  ...
  {
    static const std::vector<std::string> types = { "application/vnd.vtp" };
    return types;
  }
