...
class reader_Splat : public f3d::reader
{
public:
  reader_Splat() = default;

  /*
   * Get the name of this reader
   */
  const std::string getName() const override { return "Splat"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "3D Gaussian splats"; }
  ...
  {
    static const std::vector<std::string> ext = { "splat" };
    return ext;
  }
  ...
  {
    static const std::vector<std::string> types = { "application/vnd.splat" };
    return types;
  }
  ...
  {
    vtkNew<vtkF3DSplatReader> geomReader;
