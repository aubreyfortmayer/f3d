...
class reader_STL : public f3d::reader
{
public:
  reader_STL() = default;
   ...
   */
  const std::string getName() const override { return "STL"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "Standard Triangle Language"; }
  ...
  {
    vtkNew<vtkSTLReader> geomReader;
...
#if 1
#include "/Users/aubreyfortmayer/f3d/plugins/native/stl.inl"
#endif
