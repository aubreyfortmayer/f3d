...
#ifndef F3DVTKLegacy_h
#define F3DVTKLegacy_h
...
class reader_VTKLegacy : public f3d::reader
{
public:
  reader_VTKLegacy() = default;

  /*
   * Get the name of this reader
   */
  const std::string getName() const override { return "VTKLegacy"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "VTK Legacy"; }
  ...
  {
    vtkNew<vtkPDataSetReader> geomReader;
