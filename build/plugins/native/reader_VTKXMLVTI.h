...
#ifndef F3DVTKXMLVTI_h
#define F3DVTKXMLVTI_h
...
class reader_VTKXMLVTI : public f3d::reader
{
public:
  reader_VTKXMLVTI() = default;

  /*
   * Get the name of this reader
   */
  const std::string getName() const override { return "VTKXMLVTI"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "VTK XML ImageData"; }
  ...
  {
    static const std::vector<std::string> ext = { "vti" };
    return ext;
  }
  ...
  {
    static const std::vector<std::string> types = { "application/vnd.vti" };
    return types;
  }
