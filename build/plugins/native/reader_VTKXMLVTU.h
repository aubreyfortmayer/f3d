...
#ifndef F3DVTKXMLVTU_h
#define F3DVTKXMLVTU_h
...
class reader_VTKXMLVTU : public f3d::reader
{
public:
  reader_VTKXMLVTU() = default;

  /*
   * Get the name of this reader
   */
  const std::string getName() const override { return "VTKXMLVTU"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "VTK XML UnstructuredGrid"; }
  ...
  {
    static const std::vector<std::string> ext = { "vtu" };
    return ext;
  }
  ...
  {
    static const std::vector<std::string> types = { "application/vnd.vtu" };
    return types;
  }
