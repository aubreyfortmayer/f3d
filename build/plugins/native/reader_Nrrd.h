...
class reader_Nrrd : public f3d::reader
{
public:
  reader_Nrrd() = default;
   ...
   */
  const std::string getName() const override { return "Nrrd"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "Nearly Raw Raster Data"; }
  ...
  {
    vtkNew<vtkNrrdReader> geomReader;
