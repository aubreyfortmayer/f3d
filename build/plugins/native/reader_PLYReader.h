...
class reader_PLYReader : public f3d::reader
{
public:
  reader_PLYReader() = default;
   ...
   */
  const std::string getShortDescription() const override { return "Polygon"; }
  ...
  {
    vtkNew<vtkPLYReader> geomReader;
