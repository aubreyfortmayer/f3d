...
class reader_CityGML : public f3d::reader
{
public:
  reader_CityGML() = default;

  /*
   * Get the name of this reader
   */
  const std::string getName() const override { return "CityGML"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "CityGML"; }
  ...
  {
    vtkNew<vtkCityGMLReader> geomReader;
