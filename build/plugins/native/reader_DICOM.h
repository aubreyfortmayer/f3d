...
class reader_DICOM : public f3d::reader
{
public:
  reader_DICOM() = default;

  /*
   * Get the name of this reader
   */
  const std::string getName() const override { return "DICOM"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "DICOM"; }
  ...
  {
    vtkNew<vtkDICOMImageReader> geomReader;
