...
#ifndef F3DVTKXMLVTM_h
#define F3DVTKXMLVTM_h
...
class reader_VTKXMLVTM : public f3d::reader
{
public:
  reader_VTKXMLVTM() = default;

  /*
   * Get the name of this reader
   */
  const std::string getName() const override { return "VTKXMLVTM"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "VTK XML MultiBlock"; }
  ...
  {
    static const std::vector<std::string> ext = { "vtm" };
    return ext;
  }
  ...
  {
    static const std::vector<std::string> types = { "application/vnd.vtm" };
    return types;
  }
