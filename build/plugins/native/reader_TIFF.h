...
class reader_TIFF : public f3d::reader
{
public:
  reader_TIFF() = default;
   ...
   */
  const std::string getName() const override { return "TIFF"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "TIFF"; }
  ...
  {
    static const std::vector<std::string> ext = { "tiff", "tif" };
    return ext;
  }
  ...
  {
    vtkNew<vtkTIFFReader> geomReader;
