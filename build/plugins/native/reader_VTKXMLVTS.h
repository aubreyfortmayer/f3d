...
#ifndef F3DVTKXMLVTS_h
#define F3DVTKXMLVTS_h
...
class reader_VTKXMLVTS : public f3d::reader
{
public:
  reader_VTKXMLVTS() = default;

  /*
   * Get the name of this reader
   */
  const std::string getName() const override { return "VTKXMLVTS"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "VTK XML StructuredGrid"; }
  ...
  {
    static const std::vector<std::string> ext = { "vts" };
    return ext;
  }
  ...
  {
    static const std::vector<std::string> types = { "application/vnd.vts" };
    return types;
  }
