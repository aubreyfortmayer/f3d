...
#ifndef F3DMetaImage_h
#define F3DMetaImage_h
...
class reader_MetaImage : public f3d::reader
{
public:
  reader_MetaImage() = default;

  /*
   * Get the name of this reader
   */
  const std::string getName() const override { return "MetaImage"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "MetaImage"; }
  ...
  {
    vtkNew<vtkMetaImageReader> geomReader;
